...
module.exports = function xhrAdapter(config) {
  return new Promise(function dispatchXhrRequest(resolve, reject) {
    ...
    if (!window.XMLHttpRequest && "production" !== 'test' && typeof window !== 'undefined' && window.XDomainRequest && !('withCredentials' in request) && !isURLSameOrigin(config.url)) {
...
exports = module.exports = __webpack_require__("lHCM");
exports.init = init;
exports.log = log;
...
// EXTERNAL MODULE: /Users/user/Works/js/Preact-series/node_modules/axios/index.js
...
function task__classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function task__possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return call && (typeof call === "object" || typeof call === "function") ? call : self; }

function task__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }
...
var task_Task = function (_Component) {
    task__inherits(Task, _Component);

    function Task() {
        var _temp, _this, _ret;

        task__classCallCheck(this, Task);

        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
        }

        return _ret = (_temp = (_this = task__possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.state = { data: [] }, _temp), task__possibleConstructorReturn(_this, _ret);
    }

    Task.prototype.componentDidMount = function componentDidMount() {
        var _this2 = this;

        this.getPostData().then(function (data) {
            _this2.setState({ data: data });
            console.log("Data Loaded", data, _this2);
        });
    };

    Task.prototype.getPostData = function getPostData() {
    ...
    Task.prototype.render = function render(_ref, _ref2) {
        var data = _ref2.data;
...
var app__ref3 = Object(preact_min["h"])(task_Task, { path: '/task/' });
...
var debug = __webpack_require__("raXa")('follow-redirects');
...
if (typeof process !== 'undefined' && process.type === 'renderer') {
  module.exports = __webpack_require__("BYFN");
} else {
  module.exports = __webpack_require__("7OXw");
}
